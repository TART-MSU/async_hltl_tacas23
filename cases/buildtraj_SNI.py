...
tau2_proc1_diameter =int(sys.argv[1])
tau2_proc2_diameter =int(sys.argv[2])
...
FINAL_FORMULA = build_AND2(M1, build_AND2(M2,
                build_AND2(VALID_TAU1, build_AND2(VALID_TAU2,
                build_AND2(old_phi,build_AND2(FORMULA_TAU1, NOT+FORMULA_TAU2))))))


# FINAL_FORMULA = build_AND_multi([M1, M2,old_phi,FORMULA_TAU1, NOT+FORMULA_TAU2])
# build_AND2(M1, build_AND2(M2,
#                 build_AND2(VALID_TAU1, build_AND2(VALID_TAU2,
#                 build_AND2(old_phi,build_AND2(FORMULA_TAU1, NOT+FORMULA_TAU2))))))
